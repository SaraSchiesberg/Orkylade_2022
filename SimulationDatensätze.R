...
# Diese Spalten sollen in jeder Ergebnistabelle dieselben Daten enthalten: 
id <- seq(1:100)
# Spalte Namen
...
# Jede Ergebnistabelle soll die folgenden Mermalsausprägungen beinhalten:
...
# Für jeden Prüfling wird nun eine Tabelle erzeugt. Diese nun definierten Spalten haben in jeder Ergebnistabelle verschiedene Werte: 
